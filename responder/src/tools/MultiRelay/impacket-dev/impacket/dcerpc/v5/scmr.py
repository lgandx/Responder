...
class LPBOUNDED_DWORD_256K(NDRPOINTER):
    referent = (("Data", BOUNDED_DWORD_256K),)
...
class LPQUERY_SERVICE_CONFIGW(NDRPOINTER):
    referent = (("Data", QUERY_SERVICE_CONFIGW),)
...
class STRING_PTRSW(NDRSTRUCT):
    structure = (("Data", NDRUniConformantArray),)
...
class SERVICE_DESCRIPTION_WOW64(NDRSTRUCT):
    structure = (("dwDescriptionOffset", DWORD),)


class SERVICE_DESCRIPTIONW(NDRSTRUCT):
    structure = (("lpDescription", LPWSTR),)


class LPSERVICE_DESCRIPTIONW(NDRPOINTER):
    referent = (("Data", SERVICE_DESCRIPTIONW),)
...
class LPSERVICE_FAILURE_ACTIONSW(NDRPOINTER):
    referent = (("Data", SERVICE_FAILURE_ACTIONSW),)


class SERVICE_FAILURE_ACTIONS_FLAG(NDRSTRUCT):
    structure = (("fFailureActionsOnNonCrashFailures", BOOL),)


class LPSERVICE_FAILURE_ACTIONS_FLAG(NDRPOINTER):
    referent = (("Data", SERVICE_FAILURE_ACTIONS_FLAG),)


class SERVICE_DELAYED_AUTO_START_INFO(NDRSTRUCT):
    structure = (("fDelayedAutostart", BOOL),)


class LPSERVICE_DELAYED_AUTO_START_INFO(NDRPOINTER):
    referent = (("Data", SERVICE_DELAYED_AUTO_START_INFO),)


class SERVICE_SID_INFO(NDRSTRUCT):
    structure = (("dwServiceSidType", DWORD),)


class LPSERVICE_SID_INFO(NDRPOINTER):
    referent = (("Data", SERVICE_SID_INFO),)
...
class LPSERVICE_RPC_REQUIRED_PRIVILEGES_INFO(NDRPOINTER):
    referent = (("Data", SERVICE_RPC_REQUIRED_PRIVILEGES_INFO),)


class SERVICE_REQUIRED_PRIVILEGES_INFO_WOW64(NDRSTRUCT):
    structure = (("dwRequiredPrivilegesOffset", DWORD),)


class SERVICE_PRESHUTDOWN_INFO(NDRSTRUCT):
    structure = (("dwPreshutdownTimeout", DWORD),)


class LPSERVICE_PRESHUTDOWN_INFO(NDRPOINTER):
    referent = (("Data", SERVICE_PRESHUTDOWN_INFO),)
...
class PSERVICE_NOTIFY_STATUS_CHANGE_PARAMS_1(NDRPOINTER):
    referent = (("Data", SERVICE_NOTIFY_STATUS_CHANGE_PARAMS_1),)


class PSERVICE_NOTIFY_STATUS_CHANGE_PARAMS_2(NDRPOINTER):
    referent = (("Data", SERVICE_NOTIFY_STATUS_CHANGE_PARAMS_2),)
...
class PSERVICE_TRIGGER_SPECIFIC_DATA_ITEM(NDRPOINTER):
    referent = (("Data", SERVICE_TRIGGER_SPECIFIC_DATA_ITEM_ARRAY),)
...
class PSERVICE_TRIGGER(NDRPOINTER):
    referent = (("Data", SERVICE_TRIGGER_ARRAY),)


class SERVICE_CONTROL_STATUS_REASON_OUT_PARAMS(NDRSTRUCT):
    structure = (("ServiceStatus", SERVICE_STATUS_PROCESS),)
...
class PSERVICE_TRIGGER_INFO(NDRPOINTER):
    referent = (("Data", SERVICE_TRIGGER_INFO),)
...
class LPSERVICE_PREFERRED_NODE_INFO(NDRPOINTER):
    referent = (("Data", SERVICE_PREFERRED_NODE_INFO),)


class SERVICE_RUNLEVEL_INFO(NDRSTRUCT):
    structure = (("eLowestRunLevel", DWORD),)


class PSERVICE_RUNLEVEL_INFO(NDRPOINTER):
    referent = (("Data", SERVICE_RUNLEVEL_INFO),)


class SERVICE_MANAGEDACCOUNT_INFO(NDRSTRUCT):
    structure = (("fIsManagedAccount", DWORD),)


class PSERVICE_MANAGEDACCOUNT_INFO(NDRPOINTER):
    referent = (("Data", SERVICE_MANAGEDACCOUNT_INFO),)
...
class RCloseServiceHandle(NDRCALL):
    opnum = 0
    structure = (("hSCObject", SC_RPC_HANDLE),)
...
class RDeleteService(NDRCALL):
    opnum = 2
    structure = (("hService", SC_RPC_HANDLE),)
...
class RLockServiceDatabase(NDRCALL):
    opnum = 3
    structure = (("hSCManager", SC_RPC_HANDLE),)
...
class RGetNotifyResults(NDRCALL):
    opnum = 48
    structure = (("hNotify", SC_NOTIFY_RPC_HANDLE),)
...
class RCloseNotifyHandle(NDRCALL):
    opnum = 49
    structure = (("phNotify", SC_NOTIFY_RPC_HANDLE),)
...
def hRSetServiceObjectSecurity(
    dce, hService, dwSecurityInformation, lpSecurityDescriptor, cbBufSize
):
