...
class SMBSessionSetupAndxAUTH(Packet):
    ...
    def calculate(self):
        ...
        SecurityBlobLen = (
            str(self.fields["ApplicationHeaderTag"])
            + str(self.fields["ApplicationHeaderTagLenOfLen"])
            + str(self.fields["ApplicationHeaderLen"])
            + str(self.fields["AsnSecMechType"])
            + str(self.fields["AsnSecMechLenOfLen"])
            + str(self.fields["AsnSecMechLen"])
            + str(self.fields["ChoosedTag"])
            + str(self.fields["ChoosedTagLenOfLen"])
            + str(self.fields["ChoosedTagLen"])
            + str(self.fields["ChoosedTag1"])
            + str(self.fields["ChoosedTag1StrLenOfLen"])
        ...
        CompletePacketLen = (
            ...
            + str(self.fields["ChoosedTag1StrLen"])
            + str(self.fields["Data"])
            + str(self.fields["NLMPAuthMsgNull"])
            + str(self.fields["NativeOs"])
            + str(self.fields["NativeOsTerminator"])
        ...
        ## Packet len
        self.fields["andxoffset"] = StructWithLenPython2or3(
            "<h", len(CompletePacketLen) + 32
        )  # SMB1 Header is always 32
        ##Buff Len
        self.fields["securitybloblength"] = StructWithLenPython2or3(
            "<h", len(SecurityBlobLenUpdated)
        )
        ##Complete Buff Len
        self.fields["bcc1"] = StructWithLenPython2or3(
            "<h", len(CompletePacketLen) - 27
...
class SMBNTCreateData(Packet):
    ...
    def calculate(self):
        ...
        self.fields["FileNameLen"] = StructWithLenPython2or3(
...
class SMBWriteData(Packet):
    ...
    def calculate(self):
        ...
        self.fields["DataLenLow"] = StructWithLenPython2or3(
            "<H", len(str(self.fields["Data"]))
        )
        self.fields["Bcc"] = StructWithLenPython2or3(
            "<H", len(str(self.fields["Data"]))
...
class SMBDCERPCWriteData(Packet):
    ...
    def calculate(self):
        self.fields["Remaining"] = StructWithLenPython2or3(
            "<h", len(str(self.fields["Data"]))
        )
        self.fields["DataLenLow"] = StructWithLenPython2or3(
            "<h", len(str(self.fields["Data"]))
...
class SMBDCEData(Packet):
    fields = OrderedDict(
        [
            ...
            (
                "CTX0UID",
                "\x81\xbb\x7a\x36\x44\x98\xf1\x35\xad\x32\x98\xf0\x38\x00\x10\x03",
            ),
    ...
    def calculate(self):
        ...
        Data1 = (
            ...
            + str(self.fields["CTX0UIDVersionlo"])
            + str(self.fields["CTX0UIDSyntax"])
            + str(self.fields["CTX0UIDSyntaxVer"])
        )
...
class SMBDCEPacketData(Packet):
    ...
    def calculate(self):
        ...
        self.fields["FragLen"] = StructWithLenPython2or3("<h", len(Data1))
        self.fields["AllocHint"] = StructWithLenPython2or3(
...
class SMBDCESVCCTLOpenManagerW(Packet):
    ...
    def calculate(self):
        ...
        ## Convert to UTF-16LE
        self.fields["MaxCount"] = StructWithLenPython2or3(
            "<i", len(str(self.fields["MachineName"])) + 1
        )
        self.fields["ActualCount"] = StructWithLenPython2or3(
            "<i", len(str(self.fields["MachineName"])) + 1
        )
        self.fields["MachineName"] = (
            self.fields["MachineName"].encode("utf-16le").decode("latin-1")
        )
...
class SMBDCESVCCTLCreateService(Packet):
    ...
    def calculate(self):
        ...
        ## Calculate first
        self.fields["BinPathMaxCount"] = StructWithLenPython2or3(
            "<i", len(BinDataLen) + 1
        )
        self.fields["BinPathActualCount"] = StructWithLenPython2or3(
            "<i", len(BinDataLen) + 1
        )
        self.fields["MaxCount"] = StructWithLenPython2or3(
        ...
        self.fields["MaxCountRefID"] = StructWithLenPython2or3(
            "<i", len(str(self.fields["DisplayNameID"])) + 1
        )
        self.fields["ActualCountRefID"] = StructWithLenPython2or3(
            "<i", len(str(self.fields["DisplayNameID"])) + 1
        )

        ## Then convert to UTF-16LE
        self.fields["ServiceName"] = (
            self.fields["ServiceName"].encode("utf-16le").decode("latin-1")
        )
        self.fields["DisplayNameID"] = (
            self.fields["DisplayNameID"].encode("utf-16le").decode("latin-1")
        )
        self.fields["BinCMD"] = (
            self.fields["BinCMD"].encode("utf-16le").decode("latin-1")
        )
...
class SMBDCEMimiKatzRPCCommand(Packet):
    ...
    def calculate(self):
        self.fields["ContextHandleLen"] = StructWithLenPython2or3(
            "<i", len(str(self.fields["CMD"])) + 1
        )
        self.fields["ContextHandleLen2"] = StructWithLenPython2or3(
            "<i", len(str(self.fields["CMD"])) + 1
        )
...
class OpenAndX(Packet):
    ...
    def calculate(self):
        self.fields["Bcc"] = StructWithLenPython2or3(
            ...
            len(
                str(self.fields["Terminator"])
                + str(self.fields["File"])
                + str(self.fields["FileNull"])
            ),
        )
...
class SMBDCEWinRegOpenKey(Packet):
    ...
    def calculate(self):
        ...
        # Calc first.
        self.fields["ActualKeyMaxSize"] = StructWithLenPython2or3(
            "<i", len(str(self.fields["Key"])) + 1
        )
        self.fields["ActualKeySize"] = StructWithLenPython2or3(
            "<i", len(str(self.fields["Key"])) + 1
        )
        # Convert to unicode.
        self.fields["Key"] = self.fields["Key"].encode("utf-16le").decode("latin-1")
        # Recalculate again, in unicode this time.
        self.fields["KeySizeUnicode"] = StructWithLenPython2or3(
            "<h", len(str(self.fields["Key"])) + 2
        )
        self.fields["MaxKeySizeUnicode"] = StructWithLenPython2or3(
            "<h", len(str(self.fields["Key"])) + 2
        )
...
class SMBDCEWinRegCreateKey(Packet):
    ...
    def calculate(self):
        ...
        # Convert to unicode.
        self.fields["KeyName"] = (
            self.fields["KeyName"].encode("utf-16le").decode("latin-1")
        )
        # Recalculate again, in unicode this time.
        self.fields["KeySizeUnicode"] = StructWithLenPython2or3(
...
class SMBDCEWinRegSaveKey(Packet):
    ...
    def calculate(self):
        ...
        # Calc first.
        self.fields["ActualFileMaxSize"] = StructWithLenPython2or3(
            "<i", len(str(self.fields["File"])) + 1
        )
        self.fields["ActualFileSize"] = StructWithLenPython2or3(
            "<i", len(str(self.fields["File"])) + 1
        )
        # Convert to unicode.
        self.fields["File"] = self.fields["File"].encode("utf-16le").decode("latin-1")
        # Recalculate again, in unicode this time.
        self.fields["FileSizeUnicode"] = StructWithLenPython2or3(
            "<h", len(str(self.fields["File"])) + 2
        )
        self.fields["MaxFileSizeUnicode"] = StructWithLenPython2or3(
            "<h", len(str(self.fields["File"])) + 2
        )
