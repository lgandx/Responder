...
class PRPC_UNICODE_STRING(NDRPOINTER):
    referent = (("Data", RPC_UNICODE_STRING),)
...
class POBJECT_TYPE_LIST(NDRPOINTER):
    referent = (("Data", OBJECT_TYPE_LIST),)
...
class PSYSTEMTIME(NDRPOINTER):
    referent = (("Data", SYSTEMTIME),)


# 2.3.15 ULARGE_INTEGER
class ULARGE_INTEGER(NDRSTRUCT):
    structure = (("QuadPart", LONG64),)


class PULARGE_INTEGER(NDRPOINTER):
    referent = (("Data", ULARGE_INTEGER),)
...
class PSECURITY_INFORMATION(NDRPOINTER):
    referent = (("Data", SECURITY_INFORMATION),)
