...
class PTASK_NAMES_ARRAY(NDRPOINTER):
    referent = (("Data", TASK_NAMES_ARRAY),)
...
class PSYSTEMTIME_ARRAY(NDRPOINTER):
    referent = (("Data", SYSTEMTIME_ARRAY),)
...
class LPTASK_USER_CRED_ARRAY(NDRPOINTER):
    referent = (("Data", TASK_USER_CRED_ARRAY),)
...
class PTASK_XML_ERROR_INFO(NDRPOINTER):
    referent = (("Data", TASK_XML_ERROR_INFO),)
...
def hSchRpcEnumFolders(
    dce, path, flags=TASK_ENUM_HIDDEN, startIndex=0, cRequested=0xFFFFFFFF
):
