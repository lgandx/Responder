...
class DCERPCSessionError(DCERPCException):
    ...
    def __str__(self):
        ...
        if key in system_errors.ERROR_MESSAGES:
            ...
            return "WKST SessionError: code: 0x%x - %s - %s" % (
                self.error_code,
                error_msg_short,
                error_msg_verbose,
            )
...
class LPWKSSVC_IDENTIFY_HANDLE(NDRPOINTER):
    referent = (("Data", WKSSVC_IDENTIFY_HANDLE),)
...
class LPWKSSVC_IMPERSONATE_HANDLE(NDRPOINTER):
    referent = (("Data", WKSSVC_IMPERSONATE_HANDLE),)
...
class WKSTA_USER_INFO_0(NDRSTRUCT):
    structure = (("wkui0_username", LPWSTR),)
...
class LPSTAT_WORKSTATION_0(NDRPOINTER):
    referent = (("Data", STAT_WORKSTATION_0),)
...
class LPWKSTA_USER_INFO_0_ARRAY(NDRPOINTER):
    referent = (("Data", WKSTA_USER_INFO_0_ARRAY),)
...
class LPWKSTA_USER_INFO_0_CONTAINER(NDRPOINTER):
    referent = (("Data", WKSTA_USER_INFO_0_CONTAINER),)
...
class LPWKSTA_USER_INFO_1_ARRAY(NDRPOINTER):
    referent = (("Data", WKSTA_USER_INFO_1_ARRAY),)
...
class LPWKSTA_USER_INFO_1_CONTAINER(NDRPOINTER):
    referent = (("Data", WKSTA_USER_INFO_1_CONTAINER),)
...
class LPWKSTA_TRANSPORT_INFO_0_ARRAY(NDRPOINTER):
    referent = (("Data", WKSTA_TRANSPORT_INFO_0_ARRAY),)
...
class LPWKSTA_TRANSPORT_INFO_0_CONTAINER(NDRPOINTER):
    referent = (("Data", WKSTA_TRANSPORT_INFO_0_CONTAINER),)
...
class PJOINPR_ENCRYPTED_USER_PASSWORD(NDRPOINTER):
    referent = (("Data", JOINPR_ENCRYPTED_USER_PASSWORD),)
...
class PUNICODE_STRING_ARRAY(NDRPOINTER):
    referent = (("Data", UNICODE_STRING_ARRAY),)
...
class PNET_COMPUTER_NAME_ARRAY(NDRPOINTER):
    referent = (("Data", NET_COMPUTER_NAME_ARRAY),)
...
class LPUSE_INFO_0_CONTAINER(NDRPOINTER):
    referent = (("Data", USE_INFO_0_CONTAINER),)
...
class LPUSE_INFO_1_CONTAINER(NDRPOINTER):
    referent = (("Data", USE_INFO_1_CONTAINER),)
...
class LPUSE_INFO_2_CONTAINER(NDRPOINTER):
    referent = (("Data", USE_INFO_2_CONTAINER),)
...
def hNetrWkstaTransportEnum(
    dce, level, resumeHandle=0, preferredMaximumLength=0xFFFFFFFF
):
...
def hNetrJoinDomain2(
    dce, domainNameParam, machineAccountOU, accountName, password, options
):
...
def hNetrRemoveAlternateComputerName(
    dce, alternateName, domainAccount, encryptedPassword
):
