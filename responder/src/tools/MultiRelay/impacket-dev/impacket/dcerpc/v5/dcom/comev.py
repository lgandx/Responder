...
class DCERPCSessionError(DCERPCException):
    ...
    def __str__(self):
        if self.error_code in hresult_errors.ERROR_MESSAGES:
            ...
            return "COMEV SessionError: code: 0x%x - %s - %s" % (
                self.error_code,
                error_msg_short,
                error_msg_verbose,
            )
...
IID_IEventSystemInitialize = uuidtup_to_bin(
    ("a0e8f27a-888c-11d1-b763-00c04fb926af", "0.0")
)
IID_IEventObjectCollection = uuidtup_to_bin(
    ("f89ac270-d4eb-11d1-b682-00805fc79216", "0.0")
)
...
IID_IEventSubscription2 = uuidtup_to_bin(
    ("4A6B0E16-2E38-11D1-9965-00C04FBBB345", "0.0")
)
IID_IEventSubscription3 = uuidtup_to_bin(
    ("FBC1D17D-C498-43a0-81AF-423DDD530AF6", "0.0")
)
...
class IEventClass_put_EventClassID(DCOMCALL):
    opnum = 8
    structure = (("bstrEventClassID", BSTR),)
...
class IEventClass_put_EventClassName(DCOMCALL):
    opnum = 10
    structure = (("bstrEventClassName", BSTR),)
...
class IEventClass_put_FiringInterfaceID(DCOMCALL):
    opnum = 14
    structure = (("bstrFiringInterfaceID", BSTR),)
...
class IEventClass_put_Description(DCOMCALL):
    opnum = 16
    structure = (("bstrDescription", BSTR),)
...
class IEventClass2_put_PublisherID(DCOMCALL):
    opnum = 22
    structure = (("bstrPublisherID", BSTR),)
...
class IEventClass2_put_MultiInterfacePublisherFilterCLSID(DCOMCALL):
    opnum = 24
    structure = (("bstrPubFilCLSID", BSTR),)
...
class IEventClass2_put_AllowInprocActivation(DCOMCALL):
    opnum = 26
    structure = (("fAllowInprocActivation", BOOLEAN),)
...
class IEventClass2_put_FireInParallel(DCOMCALL):
    opnum = 28
    structure = (("pfFireInParallel", BOOLEAN),)
...
class IEventSubscription_put_SubscriptionID(DCOMCALL):
    opnum = 8
    structure = (("bstrSubscriptionID", BSTR),)
...
class IEventSubscription_put_SubscriptionName(DCOMCALL):
    opnum = 10
    structure = (("strSubscriptionID", BSTR),)
...
class IEventSubscription_put_SubscriberCLSID(DCOMCALL):
    opnum = 18
    structure = (("bstrSubscriberCLSID", BSTR),)
...
class IEventSubscription_put_SubscriberInterface(DCOMCALL):
    opnum = 20
    structure = (("pSubscriberInterface", PMInterfacePointer),)
...
class IEventSubscription_put_MachineName(DCOMCALL):
    opnum = 30
    structure = (("bstrMachineName", BSTR),)
...
class IEventSubscription_GetPublisherProperty(DCOMCALL):
    opnum = 31
    structure = (("bstrPropertyName", BSTR),)
...
class IEventSubscription_put_InterfaceID(DCOMCALL):
    opnum = 40
    structure = (("bstrInterfaceID", BSTR),)
...
class IEventClass3_put_EventClassPartitionID(DCOMCALL):
    opnum = 30
    structure = (("bstrEventClassPartitionID", BSTR),)
...
class IEventClass3_put_EventClassApplicationID(DCOMCALL):
    opnum = 32
    structure = (("bstrEventClassApplicationID", BSTR),)
...
class IEventSubscription2_put_FilterCriteria(DCOMCALL):
    opnum = 42
    structure = (("bstrFilterCriteria", BSTR),)
...
class IEventSubscription3_put_SubscriberPartitionID(DCOMCALL):
    opnum = 50
    structure = (("bstrSubscriberPartitionID", BSTR),)
...
class IEventSubscription3_put_SubscriberApplicationID(DCOMCALL):
    opnum = 52
    structure = (("bstrSubscriberApplicationID", BSTR),)
...
class IEventSystemInitialize_SetCOMCatalogBehaviour(DCOMCALL):
    opnum = 3
    structure = (("bRetainSubKeys", BOOLEAN),)
...
class IEventSystem(IDispatch):
    ...
    def Query(self, progID, queryCriteria):
        ...
        return IEventObjectCollection(
            iInterface.RemQueryInterface(1, (IID_IEventObjectCollection,))
        )
