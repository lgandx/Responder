...
from responder.src.packets import DNS_Ans, DNS_SRV_Ans, DNS6_Ans, DNS_AnsOPT
    ...
    def handle(self):
        ...
        try:
            ...
            if ParseDNSType(NetworkRecvBufferPython2or3(data)) == "A":
                ...
                print(
                    color(
                        ...
                        % (self.client_address[0].replace("::ffff:", ""), ResolveName),
                        2,
                        1,
                    )
                )
            ...
            if ParseDNSType(NetworkRecvBufferPython2or3(data)) == "OPTIPv4":
                ...
                print(
                    color(
                        "[*] [DNS] A OPT Record poisoned answer sent to: %-15s  Requested name: %s"
                        % (self.client_address[0].replace("::ffff:", ""), ResolveName),
                        2,
                        1,
                    )
            ...
            if ParseDNSType(NetworkRecvBufferPython2or3(data)) == "IPv6" and Have_IPv6:
                ...
                print(
                    color(
                        "[*] [DNS] AAAA Record poisoned answer sent to: %-15s  Requested name: %s"
                        % (self.client_address[0].replace("::ffff:", ""), ResolveName),
                        2,
                        1,
                    )
            ...
            if (
                ParseDNSType(NetworkRecvBufferPython2or3(data)) == "OPTIPv6"
                and Have_IPv6
            ):
                buff = DNS6_Ans()
                buff.calculate(NetworkRecvBufferPython2or3(data))
                ...
                print(
                    color(
                        "[*] [DNS] AAAA OPT Record poisoned answer sent to: %-15s  Requested name: %s"
                        % (self.client_address[0].replace("::ffff:", ""), ResolveName),
                        2,
                        1,
                    )
    ...
    def handle(self):
        ...
        try:
            ...
            if ParseDNSType(NetworkRecvBufferPython2or3(data)) == "SRV":
                ...
                print(
                    color(
                        "[*] [DNS] SRV Record poisoned answer sent: %-15s  Requested name: %s"
                        % (self.client_address[0].replace("::ffff:", ""), ResolveName),
                        2,
                        1,
                    )
            ...
            if ParseDNSType(NetworkRecvBufferPython2or3(data)) == "IPv6" and Have_IPv6:
                ...
                print(
                    color(
                        "[*] [DNS] AAAA Record poisoned answer sent: %-15s  Requested name: %s"
                        % (self.client_address[0].replace("::ffff:", ""), ResolveName),
                        2,
                        1,
                    )
            ...
            if (
                ...
                print(
                    color(
                        "[*] [DNS] AAAA OPT Record poisoned answer sent: %-15s  Requested name: %s"
                        % (self.client_address[0].replace("::ffff:", ""), ResolveName),
                        2,
                        1,
                    )
