...
MSRPC_UUID_IPHLP_IP_TRANSITION = uuidtup_to_bin(
    ("552d076a-cb29-4e44-8b6a-d15e59e2c0af", "1.0")
)

# RPC_IF_ALLOW_LOCAL_ONLY
MSRPC_UUID_IPHLP_TEREDO = uuidtup_to_bin(
    ("ecbdb051-f208-46b9-8c8b-648d9d3f3944", "1.0")
)
MSRPC_UUID_IPHLP_TEREDO_CONSUMER = uuidtup_to_bin(
    ("1fff8faa-ec23-4e3f-a8ce-4b2f8707e636", "1.0")
)
...
class DCERPCSessionError(DCERPCException):
    ...
    def __str__(self):
        ...
        if key in hresult_errors.ERROR_MESSAGES:
            ...
            return "IPHLP SessionError: code: 0x%x - %s - %s" % (
                self.error_code,
                error_msg_short,
                error_msg_verbose,
            )
...
class IpTransitionProtocolApplyConfigChanges(NDRCALL):
    opnum = 0
    structure = (("NotificationNum", BYTE),)
...
OPNUMS = {
    0: (
        IpTransitionProtocolApplyConfigChanges,
